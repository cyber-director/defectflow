    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-app px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-ink-primary">DefectFlow Staff</h1>
          <p className="mt-2 text-sm text-ink-secondary">Maintenance staff sign-in.</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <p className="text-center text-sm text-ink-muted">
              <Link href="/login" className="font-medium text-ink-secondary hover:text-ink-primary hover:underline">
                Sign in as user
              </Link>
            </p>
          </div>
